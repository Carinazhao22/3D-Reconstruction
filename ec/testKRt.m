...
fprintf('------------------------------\n');
fprintf('Intrinsic Error with noisy 2D points is %.4f\n',...
    norm(KNoisy/KNoisy(end) - K/K(end)));
fprintf('Rotation Error with noisy 2D points is %.4f\n',...
    norm(RNoisy - R));
fprintf('Translation Error with noisy 2D points is %.4f\n', ...
    norm(tNoisy - t));
